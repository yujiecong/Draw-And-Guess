...
QT_MOC_LITERAL(1, 10, 28), // "signalsReceivedClientMessage"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 27) // "slotsDataReceivedFromClient"

    },
    "TcpSocket\0signalsReceivedClientMessage\0"
    "\0slotsDataReceivedFromClient"
};
...
void TcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalsReceivedClientMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->slotsDataReceivedFromClient(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (TcpSocket::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpSocket::signalsReceivedClientMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TcpSocket::signalsReceivedClientMessage(QString _t1)
{
